...
// fontSize={"1em"} pt={2} pb={2} fontWeight={"560"}
...
export const work = ["Plumbing", "Education", "Welding", "Electrician"];
            ...
            {visibleAddresses.map((address, index) => (
              <Grid key={index}>
                <Chip
                  ...
                  sx={{
                    backgroundColor:
                      selectedIndex === index ? "#B49176" : "transparent",
                    color: selectedIndex === index ? "white" : "inherit",
                    borderColor:
                      selectedIndex === index ? "#B49176" : undefined,
                    "&:hover": {
                      backgroundColor:
                        selectedIndex === index ? "#A67C62" : "#f5f5f5",
                    },
                  }}
            ...
            {visibleSlot.map((val, index) => (
              <Grid key={index}>
                <Chip
                  ...
                  sx={{
                    backgroundColor:
                      selectedSlot === index ? "#B49176" : "transparent",
                    color: selectedSlot === index ? "white" : "inherit",
                    borderColor: selectedSlot === index ? "#B49176" : undefined,
                    "&:hover": {
                      backgroundColor:
                        selectedSlot === index ? "#A67C62" : "#f5f5f5",
                    },
                  }}
