...
const Signuppage = () => {
  return (
    <AuthenticationLayout
      mainheading="Join & Build Smart"
      subheading="Sign up to connect with trusted pros for your construction needs"
    >
      <Typography
        variant="h6"
        sx={{
      ...
      <Box pl={5} pb={5} pr={5} pt={3}>
        ...
        <Stack
          spacing={2}
          mt={3}
          sx={{ display: "flex", flexDirection: "column", pl: 3 }}
        >
          <Button
            sx={{
              borderRadius: "20px",
          ...
          <Stack direction="row" spacing={1} sx={{ pt: 1, pl: 3 }}>
            <Typography sx={{ fontSize: "12px", color: "#666666", mt: 1 }}>
