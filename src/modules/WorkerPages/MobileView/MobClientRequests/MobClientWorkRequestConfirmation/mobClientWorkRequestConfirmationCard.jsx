...
const mobClientWorkRequestConfirmationCard = ({ title, location, time, client, avatar }) => {
        ...
        <CardContent>
          <Stack direction="row" justifyContent="space-between">
            ...
            <Menu
              ...
              onClick={(e) => e.stopPropagation()} // prevent menu click from triggering navigation
            >
...
export default mobClientWorkRequestConfirmationCard;
