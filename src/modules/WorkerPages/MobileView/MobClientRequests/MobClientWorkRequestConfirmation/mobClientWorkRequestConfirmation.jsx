...
import MobClientWorkRequestConfirmationCard from './mobClientWorkRequestConfirmationCard';
...
export default function MobClientWorkRequestConfirmation() {
    ...
    return (
        <Box sx={{ bgcolor: '#fefaf7', minHeight: '100vh', p: 2 }}>
            ...
            {thisWeek.map(req => (
                <MobClientWorkRequestConfirmationCard key={req.id} {...req} />
            ))}
