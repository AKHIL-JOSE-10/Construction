...
import MobClientWorkRequestConfirmedCard from './mobClientWorkRequestConfirmedCard';
...
export default function MobClientWorkRequestConfirmed() {
    ...
    return (
        <Box sx={{ bgcolor: '#fefaf7', minHeight: '100vh', p: 2 }}>
            ...
            {thisWeek.map(req => (
                <MobClientWorkRequestConfirmedCard key={req.id} {...req} />
            ))}
