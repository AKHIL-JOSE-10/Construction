            ...
            <Grid>
                <Grid sx={{ display: 'flex', flexDirection: 'column' }}>
                    ...
                    <Box sx={{ display: 'flex', alignItems: 'center', p: 1 }}>
                        ...
                        <Typography sx={{ fontSize: '17px' }}>Joined: 12 Dec 2025</Typography>
                    </Box>

                    <Box sx={{ display: 'flex', alignItems: 'center', p: 1 }}>
                        <CategoryIcon sx={{ fontSize: 20, color: 'gray', mr: 1 }} />
                        <Typography sx={{ fontSize: '17px' }}>Category : Electrician / Plumber</Typography>
                    </Box>
                    <Typography sx={{ fontSize: '15px', p: 1, color: 'text.secondary', lineHeight: 1.8, textAlign: 'justify', maxWidth: '700px', mx: 'auto' }}>
                ...
                <Grid>
                    ...
                    <Box sx={{ display: 'flex', gap: 2,mr:2 }}>
                        ...
                        <Typography
                            sx={{ flex: '0 0 42%', p: 1.5, borderRadius: 2, backgroundColor: '#f5f5f5', fontWeight: 500, fontSize: 16, boxShadow: '0 1px 4px rgba(0,0,0,0.1)', }}>
                ...
                <Grid sx={{ display: 'flex', flexDirection: 'column',mb:2 }}>
                    ...
                    <Typography sx={{ fontSize: '17px', fontWeight: '500', px: 1, }}>Aranattukara,Thrissur</Typography>
                    <Typography sx={{ fontSize: '14px', px: 1 }}>0.2 km away</Typography>
                </Grid>
            </Grid>
