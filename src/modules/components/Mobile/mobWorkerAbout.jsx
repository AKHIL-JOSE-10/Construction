        ...
        <Grid>
            <Grid>
                <Grid sx={{ display: 'flex', flexDirection: 'column' }}>
                    ...
                    <Typography sx={{ fontSize: '15px', p: 1, color: 'black', lineHeight: 1.8, textAlign: 'justify', maxWidth: '700px', mx: 'auto' }}>
                ...
                <Grid>
                    ...
                    <Box sx={{ display: 'flex', gap: 2,mr:2,ml:0.8 }}>
                        <Typography sx={{ flex: '0 0 42%', p: 1.5, borderRadius: 2, backgroundColor: '#f5f5f5', fontWeight: 500, fontSize: 15, boxShadow: '0 1px 4px rgba(0,0,0,0.1)', }}>
                            Troubleshooting & Repair
                        </Typography>

                        <Typography
                            sx={{ flex: '0 0 42%', p: 1.5, borderRadius: 2, backgroundColor: '#f5f5f5', fontWeight: 500, fontSize: 15, boxShadow: '0 1px 4px rgba(0,0,0,0.1)', }}>
