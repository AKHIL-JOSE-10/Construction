...
const WorkerReview = () => {
    ...
    return (
        <Grid >
            <Grid sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mt: 2, mb: 2 }}>
                <Stack spacing={0.5} sx={{ pl: 1.5 }}>
                    <Stack direction="row" spacing={1} alignItems="center" >
                        <Typography sx={{ fontWeight: 'bold', fontSize: '27px' }}>4.5</Typography>
                        <Rating size="large" name="half-rating-read" defaultValue={4.5} precision={0.5} readOnly />
                    </Stack>
                    <Typography sx={{ fontSize: '15px', color: 'text.secondary' }}>2 reviews</Typography>
                </Stack>
            ...
            <WorkerReviewCard name="Jane" rate="4" date="20th dec 2025" />
