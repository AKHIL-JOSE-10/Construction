    ...
    return (
        <Grid container sx={{ bgcolor: '#B08B6F', width:"100%", height:'100%' ,display: 'flex', alignItems: 'center', justifyContent: 'center' }} >
            ...
            <Grid bgcolor={'#B08B6F'} sx={{ minHeight: '80vh', width:"100%" , display: 'flex', flexDirection: 'column' }}>
                ...
                <MobAuthHeading heading1="Join & Build" heading2="Smart" />
                        ...
                        <Box px={3} pb={5} pt={4}>
                            <Box sx={{ display: 'flex', justifyContent: 'center', mb: 3 }}>
                                <Button
                                    ...
                                    startIcon={
                                        <Box component="img" src={GoogleIcon} alt="Google Icon" sx={{ width:{xs:20,sm:40,md:30}, height: {xs:20,sm:40,md:30} }} />
                                    }
                                >
                                    <Typography sx={{ fontSize:{xs:"14px",sm:"22px",md:"23px"} }}>Continue with Google</Typography>
                                </Button>
                            </Box>
                            ...
                            <FormControlLabel
                                control={<Checkbox />}
                                label={
                                    <Typography sx={{ fontSize:{ xs: '14px', sm: '24px', md: '24px' }, color: '#111111' }}>Remember me</Typography>
                                }
                                sx={{ mt: 0 }}
                            />
                            ...
                            <Stack mt={1} sx={{ alignItems: 'center' }}>
                                ...
                                >
                                    <Typography sx={{fontSize:{xs:"15px",sm:"30px",md:"40px"}, color:"white"}}>Log in</Typography>
                                </Button>
                            </Stack>
                            ...
                            <Typography sx={{ fontSize:{ xs: '13px', sm: '20px', md: '32px' }, fontWeight: 'bold', pt: 2, textAlign: 'center' }}>
                            ...
                            <Box sx={{ display: 'flex', justifyContent: 'center', mt: 1 }}>
                                ...
                                >
                                    <Typography sx={{fontSize:{xs:"15px",sm:"28px",md:"30px"}}}>Sign up</Typography>
                                </Button>
                            </Box>
                        </Box>
